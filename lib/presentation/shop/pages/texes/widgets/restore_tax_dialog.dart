...
class RestoreTaxDialog extends HookConsumerWidget {
  final int id;
  const RestoreTaxDialog({Key? key, required this.id}) : super(key: key);
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ref.read(taxProvider.notifier).restoreTax(taxId: id);
                      },
                      child: loading
                          ? const Center(
                              child: SizedBox(
