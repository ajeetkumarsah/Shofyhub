...
import 'package:alpesportif_seller/presentation/shop/pages/delivary%20boy/delivery_boy_list_page.dart';
import 'package:alpesportif_seller/presentation/shop/pages/delivary%20boy/trash_delivery_boy_list_page.dart';
...
class DeliveryBoyPage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    useEffect(() {
      DeliveryBoyUtility.index.value = 0;
      return null;
    }, []);
