...
class RestoreRoleDialog extends HookConsumerWidget {
  final int id;
  const RestoreRoleDialog({Key? key, required this.id}) : super(key: key);
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ref.read(roleProvider.notifier).restoreRole(roleId: id);
                      },
                      child: loading
                          ? const Center(
                              child: SizedBox(
