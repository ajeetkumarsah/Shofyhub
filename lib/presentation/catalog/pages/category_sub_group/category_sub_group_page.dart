...
import 'package:alpesportif_seller/presentation/catalog/pages/category_sub_group/category_sub_group_list_page.dart';
import 'package:alpesportif_seller/presentation/catalog/pages/category_sub_group/trash_category_sub_group_list_page.dart';
...
class CategorySubgroupPage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    useEffect(() {
      CategorySubGroupUtility.index.value = 0;
      return null;
    }, []);
