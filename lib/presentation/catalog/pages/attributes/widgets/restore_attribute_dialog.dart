...
class RestoreAttributeDialog extends HookConsumerWidget {
  final int id;
  const RestoreAttributeDialog({Key? key, required this.id}) : super(key: key);
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ref
                            ...
                            .restoreAttributes(attributeId: id);
                      },
                      child: loading
                          ? const Center(
                              child: SizedBox(
