...
import 'package:alpesportif_seller/presentation/catalog/pages/attributes/attribute_list_page.dart';
import 'package:alpesportif_seller/presentation/catalog/pages/attributes/trash_attributes_list_page.dart';
...
class AttributePage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    useEffect(() {
      AttributeUtility.index.value = 0;
      return null;
    }, []);
