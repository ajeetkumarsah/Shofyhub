...
class TrashInventory extends HookConsumerWidget {
  final int inventoryId;
  const TrashInventory({Key? key, required this.inventoryId}) : super(key: key);
    ...
    ref.listen<InventoriesState>(stockeInventoryProvider, (previous, next) {
      if (previous != next && !next.loading) {
        ...
        if (next.failure == CleanFailure.none()) {
          NotificationHelper.success(message: 'item_trashed'.tr());

          // CherryToast.info(
          //   title: const Text('Inventory Trashed'),
