...
class ProceedOrderScreen extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    final List<DelivaryBoyModel> delivaryBoyList =
        ref.watch(delivaryBoyProvider).delivaryBoys;
    final ValueNotifier<DelivaryBoyModel> selectedDelivaryBoy =
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButtonFormField(
                    ...
                    items: delivaryBoyList
                        .map<DropdownMenuItem<DelivaryBoyModel>>(
                            (DelivaryBoyModel value) {
                      return DropdownMenuItem<DelivaryBoyModel>(
                        value: value,
                        child: Text(
                          value.name,
                          style: TextStyle(
                    ...
                    onChanged: (DelivaryBoyModel? newValue) {
